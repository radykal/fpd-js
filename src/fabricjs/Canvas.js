...
import { deepMerge, objectHasKeys, isUrl, isZero, isEmpty } from "../helpers/utils.js";
...
fabric.Canvas.prototype.setElementOptions = function (parameters, element) {
	...
	if (
		...
		(parameters.hasOwnProperty("shadowOffsetY") && !(element.engravedText || element.neonText))
	) {
	...
	if (element.setCurvedTextPosition) element.setCurvedTextPosition();
