...
import Options from"./Options.js";import UIManager from"../ui/UIManager";export default class FancyProductDesigner{container=null;$container=null;constructor(n,i={}){this.container=n,this.$container=$(n),this.optionsInstance=new Options,this.mainOptions=this.optionsInstance.merge(this.optionsInstance.defaults,i),this.uiManager=new UIManager(this,{onUiReady:this.#uiReady})}#uiReady(){console.log("ui ready")}}window.FancyProductDesigner=FancyProductDesigner;