...
function Ruler(text) {
	...
	Object.assign(this.collapsible.style,style)
	Object.assign(this.expandable.style,style)
	Object.assign(this.expandableInner.style,style)
	Object.assign(this.collapsibleInner.style,{
		'display':'inline-block',
		'width':'200%',
		'height':'200%',
		'font-size':'16px',
...
Ruler.prototype.onResize = function (callback) {
	...
	this.collapsible.addEventListener(this.collapsible, 'scroll', onScroll);
	 ...
	 */
export default function Observer(family, opt_descriptors) {
